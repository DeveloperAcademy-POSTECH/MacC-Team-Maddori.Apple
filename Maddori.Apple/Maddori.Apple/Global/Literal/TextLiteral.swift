...
enum TextLiteral {
    ...
    static let feedbackFromMeDetailViewControllerAlertViewTitle = "피드백 삭제하기"
    static let feedbackFromMeDetailViewControllerAlertViewSubTitle = "삭제된 피드백은 복구할 수 없습니다"
    
    // MARK: - AlertView
    
    static let alertViewCancelButtonText = "취소"
}
