...
enum ImageLiterals {
    ...
    static var imgProgressEmpty: UIImage {
        .load(name: "ProgressBarEmpty") }
    static var imgProgress2: UIImage {
        .load(name: "ProgressBar2") }
    static var imgProgress3: UIImage {
        .load(name: "ProgressBar3") }
    static var imgProgress4: UIImage {
        .load(name: "ProgressBar4") }
    static var imgProgress5: UIImage {
        .load(name: "ProgressBar5") }
}
